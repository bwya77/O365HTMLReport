...
$Sku = @{
	...
	"PROJECTPROFESSIONAL_GOV"			     = "Project Online Professional for Government"
	"ECAL_SERVICES"						     = "ECAL"
	...
	"EXCHANGEARCHIVE_ADDON_GOV"			   	 = "Exchange Online Archiving for Exchange Online for Government"
